...
public:
    ...
    void setOAIChallengesAdministratorApiHandler(QSharedPointer<OAIChallengesAdministratorApiHandler> handler);
    void setOAIChallengesUsersApiHandler(QSharedPointer<OAIChallengesUsersApiHandler> handler);
    void setOAISessionUsersApiHandler(QSharedPointer<OAISessionUsersApiHandler> handler);
private:
    ...
    QSharedPointer<OAIChallengesAdministratorApiHandler> mOAIChallengesAdministratorApiHandler;
    QSharedPointer<OAIChallengesUsersApiHandler> mOAIChallengesUsersApiHandler;
    QSharedPointer<OAISessionUsersApiHandler> mOAISessionUsersApiHandler;
protected:
