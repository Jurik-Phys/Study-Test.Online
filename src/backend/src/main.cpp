...
int main(int argc, char * argv[])
{
    ...
    QObject::connect(handler.data(), &OpenAPI::OAIApiRequestHandler::requestReceived, [&](QHttpEngine::Socket *socket) {
        ...
        socket->setHeader("Access-Control-Allow-Methods", "GET,PUT,POST,DELETE,PATCH,OPTIONS");
        socket->setHeader("Access-Control-Allow-Headers", "Authorization, Content-Type");
